...
int main(int argc, char*argv[])
{
    ...
    // USE: e.g. ./analyzePointSet 6 ../../dataTest/Vertices.xyz
    // const char* input_filename = (argc>1)?argv[1]:"../../dataTest/Vertices.xyz";
    const unsigned int nb_neighbors =  atoi(argv[1]); // 1 ring
