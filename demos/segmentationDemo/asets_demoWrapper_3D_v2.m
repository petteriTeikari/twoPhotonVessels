function region = asets_demoWrapper_3D_v2(img, vessel, edges, sliceIndex, visualize3D, visualizeON, fileOutBase)
    ...
    % 3. Initialize a region as initialization for the zero level set
        ...
        absNormVessels = abs(vessel);
        % region = absNormVessels; 
    ...
    fig = figure('Color', 'w');        
        ...
        if visualizeON
            ...
            if ~visualize3D
                ...
                downSampleFactor = [4 1]; % [xy z] downsample to get less vertices/faces
    ...
    maxLevelSetIterations = 8; % number of maximum time steps
    tau = 2500; % speed parameter
    w1 = 0.3; % weight parameter for intensity data term
